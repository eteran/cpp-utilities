...
public:
	iterator begin()              { using std::begin;  return begin(storage_); }
    const_iterator begin() const  { using std::begin;  return begin(storage_); }
    const_iterator cbegin() const { using std::cbegin; return cbegin(storage_); }
	iterator end()                { using std::end;    return end(storage_); }
    const_iterator end() const    { using std::end;    return end(storage_); }
    const_iterator cend() const   { using std::cend;   return cend(storage_); }

	reverse_iterator rbegin()              { using std::rbegin;  return rbegin(storage_); }
    const_reverse_iterator rbegin() const  { using std::rbegin;  return rbegin(storage_); }
    const_reverse_iterator crbegin() const { using std::crbegin; return crbegin(storage_); }
	reverse_iterator rend()                { using std::rend;    return rend(storage_); }
    const_reverse_iterator rend() const    { using std::rend;    return rend(storage_); }
    const_reverse_iterator crend() const   { using std::crend;   return crend(storage_); }
